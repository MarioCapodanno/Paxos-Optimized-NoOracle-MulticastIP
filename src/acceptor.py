...
class Acceptor:
    ...
    def handle_prepare(self, msg):
        ...
        Args:
            msg: ("PREPARE", ballot, proposer_id)
        """
        ...
        if RndGeq(rnd, self.promised_rnd):
            ...
            logging.debug(f"Acceptor {self.id}: ignoring PREPARE {rnd} (promised {self.promised_rnd})")
    ...
    def handle_accept(self, msg):
        ...
        if RndGeq(rnd, self.promised_rnd):
            ...
            logging.debug(f"Acceptor {self.id}: ignoring ACCEPT {rnd} (promised {self.promised_rnd})")
